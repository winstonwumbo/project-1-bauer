...
let WebSocialShare$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  get el() { return this; }
  static get style() { return webSocialShareCss; }
};
WebSocialShare$1 = /*@__PURE__*/ proxyCustomElement(WebSocialShare$1, [1, "web-social-share", {
    "show": [1028],
    "share": [16]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["web-social-share"];
  components.forEach(tagName => { switch (tagName) {
    case "web-social-share":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WebSocialShare$1);
      }
      break;
  } });
}
...
const WebSocialShare = WebSocialShare$1;
const defineCustomElement = defineCustomElement$1;

export { WebSocialShare, defineCustomElement };
